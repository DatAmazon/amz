...
# Node.js - Express, MongoDB, ES8 REST API
...
```bash
git clone https://github.com/node-api
cd node-api
rm -rf .git
```
...
## Document passport
- Theo mặc định, khi xác thực thành công, req.user thuộc tính được đặt thành người dùng đã xác thực https://www.passportjs.org/concepts/authentication/middleware/
- assignProperty: 'locals' https://github.com/jaredhanson/passport/issues/237

## MongoDb Document
- UpdateOne https://mongodb.github.io/node-mongodb-native/5.7/classes/Collection.html#updateOne