import type { MinvoiceTableColumnProps } from './type';
...
const MinvoiceTableColumn = <RecordType extends object = object>(props: MinvoiceTableColumnProps<RecordType>) => {
...
export default MinvoiceTableColumn;
